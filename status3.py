...
old_mis = pd.read_excel(r"C:\Users\kshiti.sinha\Desktop\projects\MIS TRACKER\status_of_invoice_files\data (11).xlsx",sheet_name='Export')
...
#
#
master = pd.read_excel(r"C:\Users\kshiti.sinha\Desktop\projects\MIS TRACKER\status_of_invoice_files\data (11).xlsx",sheet_name='Export')
...
car_mis = old_mis[old_mis['Creditor Status of Invoice'].isin(creditor_status)]
...
car_status_validated = creditor_mis_combo[creditor_mis_invoice['Status of Invoice'].isin(status_car1)]
...
car_status_creditor = ['Needs Revalidation','Validated']
...
payment_hold = ['Yes']
filter3 = filter1[filter1['Payment Hold Flag'].isin(payment_hold)]
car_status_docket2 = set(filter3['Docket No.'])
...
#             master.loc[i, 'Reason of Rejection/Hold'] = 'Hold by Backend/Circle Hold'
...
#####################################################################################################
master.to_excel(r"C:\Users\kshiti.sinha\Desktop\projects\MIS TRACKER\MIS DATA\OUTPUTS\status output\status_of_invoice_updatedlatest11.xlsx")
# sys.stdout.close()
